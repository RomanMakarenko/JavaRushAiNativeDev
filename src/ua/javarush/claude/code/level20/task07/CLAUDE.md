...
маленьких рефакторингів, що зберігають поведінку, за принципом безпечного інкрементального циклу: один маленький
...
- Public API (public-методи та public-поля) в межах кроку не змінюється.
