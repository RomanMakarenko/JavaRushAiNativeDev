...
Три ендпоінти для локальної демонстрації основного потоку:
- /api/health        — перевірка живості
- /api/demo-summary  — готове зведення за прикладними даними
...
def _summarize(transactions: list[dict]) -> dict:
    """Обчислює коротке зведення: суму, топ-категорію та статус."""
...
def demo_summary() -> dict:
    """Готове demo-зведення за sample-запитом із data/."""
...
def analyze(req: AnalyzeRequest) -> dict:
    """Основний потік: аналіз переданих транзакцій."""
