 ...
 * У довгому завданні з винесення decision logic публічний API цього контролера
 * змінювати не можна: шлях, метод і формат запиту/відповіді залишаються без змін.
 */
@RestController
