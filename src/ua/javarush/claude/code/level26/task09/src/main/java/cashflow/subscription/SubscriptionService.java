 ...
 * частина розподілена по MrrFormulas і RefundService.
 */
public class SubscriptionService {
    ...
    // Постановка підписки на паузу. Статус змінюється, але з active MRR
    // підписка НЕ прибирається (див. MrrFormulas.isInActiveSet).
